...
max_vert = max_vertical(grid)
max_hor = max_horizontal(grid)
max_diag_up = max_diag_up(grid)
max_diag_down = max_diag_down(grid)

print(max(max_vert, max_hor, max_diag_up, max_diag_down))